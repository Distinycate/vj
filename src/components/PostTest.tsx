...
export default function PostTest() {
  ...
  return (
    ...
    >
      <div className="absolute top-[-10%] left-[-10%] w-[400px] h-[400px] bg-secondary/20 glow-orb pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {currentQ.choices.map((choice: QuizChoice) => (
            <button 
              ...
              className="glass-input p-4 sm:p-5 text-base sm:text-lg font-bold text-center break-words hover-lift hover:border-secondary/50 hover:text-secondary cursor-pointer transition-all"
            >
              {choice.text}
            </button>
          ))}
